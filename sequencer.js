...
async function performOperation(assetID, operation, parameters) {
    ...
    console.log("❗️​ : performOperation : JSON.stringify(body):", JSON.stringify(body, null, 4))
...
async function verifyInputs(args) {
    ...
    if (fs.existsSync(args[1])) {
        ...
        console.log(`🚀 : Output folder ${outputFolderPath} created.`)
    }
    let sequenceFile;
    ...
    if (sequence[0].operation == 'createpdf') {
        ...
        console.log("🚀 : verifyInputs : startsWithCreate:", startsWithCreate)
    }
...
async function processFile(inputFileName, inputFolderPath, outputFolderPath, sequence) {
    console.log("❗️​ : processFile : inputFolderPath:", inputFolderPath)
    ...
    for (let i = 0; i < sequence.length; i++) {
        ...
        let millis = Date.now() - start;
        console.log('🚀 : Processing Time : ', (millis / 1000).toFixed(2), "seconds");
        if (response) {
            ...
            if (additionalParameters["moveCompletedToOutput"] == "true") {
                console.log("❗️​ : saveOutput : inputFolderPath:", inputFolderPath);
                console.log("❗️​ : saveOutput : outputFolderPath:", outputFolderPath);
                console.log("❗️​ : saveOutput : inputFileName:", inputFileName);
...
//console.log("🚀 : createPdfSupportedFormats:", JSON.stringify(createPdfSupportedFormats, null, 4))
let accessToken;
main();
